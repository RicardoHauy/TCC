 ...
 * @author RicardoHauy
 */
@WebServlet(name = "RelatorioTodasAcoesServlet", urlPatterns = {"/RelatorioTodasAcoesServlet"})
public class RelatorioTodasAcoesServlet extends HttpServlet {//Servlet que imprime relatório de clientes inadimplentes
